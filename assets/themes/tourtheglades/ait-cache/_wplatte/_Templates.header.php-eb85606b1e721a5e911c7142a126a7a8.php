<?php //netteCache[01]000483a:2:{s:4:"time";s:21:"0.15959200 1372952789";s:9:"callbacks";a:3:{i:0;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:9:"checkFile";}i:1;s:94:"/home2/saturdb8/public_html/tourtheglades/wp-content/themes/tourtheglades/Templates/header.php";i:2;i:1372952262;}i:1;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:20:"NFramework::REVISION";i:2;s:30:"eee17d5 released on 2011-08-13";}i:2;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:21:"WPLATTE_CACHE_VERSION";i:2;i:4;}}}?><?php

// source file: /home2/saturdb8/public_html/tourtheglades/wp-content/themes/tourtheglades/Templates/header.php

?><?php list($_l, $_g) = NCoreMacros::initRuntime($template, 'w43tmzn6ym')
;
// snippets support
...
<?php if (isset($post) && isset($post->options('slider')->overrideGlobal)): if (function_exists('putRevSlider')): if ($post->options('slider')->sliderDisplay == true): NCoreMacros::includeTemplate("parts/slider.php", array('options' => $post->options('slider')) + $template->getParams(), $_l->templates['w43tmzn6ym'])->render() ?>
							<div class="grey-bg"></div>
<?php else: ?>
							<div class="grey-bg">
<?php NCoreMacros::includeTemplate("parts/breadcrumbs.php", $template->getParams(), $_l->templates['w43tmzn6ym'])->render() ?>
							</div>
<?php endif ;else: ?>
						<div class="grey-bg">
<?php NCoreMacros::includeTemplate("parts/breadcrumbs.php", $template->getParams(), $_l->templates['w43tmzn6ym'])->render() ?>
						</div>
<?php endif ;else: if (function_exists('putRevSlider')): if ($themeOptions->sections->sliderDisplay == true): NCoreMacros::includeTemplate("parts/slider.php", array('options' => $themeOptions->sections) + $template->getParams(), $_l->templates['w43tmzn6ym'])->render() ?>
							<div class="grey-bg"></div>
<?php else: ?>
							<div class="grey-bg">
<?php NCoreMacros::includeTemplate("parts/breadcrumbs.php", $template->getParams(), $_l->templates['w43tmzn6ym'])->render() ?>
